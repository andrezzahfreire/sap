...
DATA: gd_name      TYPE zteste_cliente-name.

SELECTION-SCREEN BEGIN OF BLOCK b1 WITH FRAME.
  PARAMETERS p_kunnir TYPE zteste_cliente-kunnir.
...
ENDFORM.
FORM gravar_nome.
  UPDATE zteste_cliente
     SET name = gd_name
   WHERE kunnir = p_kunnir.
...
*     _COLLECT                 = ' '
  ...
  ELSE.
    MESSAGE |O usuário { sy-msgv1 } já esta modificando o cliente { p_kunnir }|
