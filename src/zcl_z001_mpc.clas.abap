...
public section.
  ...
  types:
    begin of TS_SEPM_I_SALESORDERITEM_ETYPE.
      include type SEPM_ISOIE.
      include type SNWD_SOI_INCL_EEW_TR.
  types:
      generated_id type string,
      T_SALESORDERITEM type SEPM_ISOITE-SALESORDERITEMNOTE,
  ...
  types:
    begin of TS_SEPM_I_SALESORDER_ETYPE.
      include type SEPM_ISOE.
      include type SNWD_SO_INCL_EEW_TR.
  types:
      generated_id type string,
      T_SALESORDER type SEPM_ISOTE-SALESORDERNOTE,
    end of TS_SEPM_I_SALESORDER_ETYPE .
  types:
   TT_SEPM_I_SALESORDER_ETYPE type standard table of TS_SEPM_I_SALESORDER_ETYPE .
  ...
  constants GC_SEPM_I_SALESORDER_ETYPE type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'SEPM_I_SalesOrder_EType' ##NO_TEXT.
...
CLASS ZCL_Z001_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z001_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20170704103624'.                  "#EC NOTEXT
...
*   4
*&---------------------------------------------------------------------*
    CONSTANTS: co_gen_date_time TYPE timestamp VALUE '20170704123626'.
    TRY.
  ...
  method IF_SADL_GW_MODEL_EXPOSURE_DATA~GET_MODEL_EXPOSURE.
    CONSTANTS: co_gen_timestamp TYPE timestamp VALUE '20170704123626'.
    DATA(lv_sadl_xml) =
   ...
   ro_model_exposure = cl_sadl_gw_model_exposure=>get_exposure_xml( iv_uuid      = CONV #( 'Z001' )
